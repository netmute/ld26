...
(function() {
  ...
  ig.module('game.entities.planet').requires('impact.entity', 'game.entities.ship', 'game.entities.fighter').defines(function() {
    return _this.EntityPlanet = ig.Entity.extend({
      ...
      init: function(settings) {
        ...
        return this.ship = [true, false].random() ? ig.game.spawnEntity(EntityShip, this.pos.x, this.pos.y + 4, {
          ki: settings.enemy
