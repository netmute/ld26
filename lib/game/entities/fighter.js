...
(function() {
  ...
  ig.module('game.entities.fighter').requires('game.entities.explosion', 'plugins.steering-behaviors').defines(function() {
    return _this.EntityFighter = SteeringBehaviorsEntity.extend({
      ...
      kill: function() {
        if (!this._killed) {
          ig.game.spawnEntity(EntityExplosion, this.pos.x - 5, this.pos.y - 5);
        }
        return this.parent();
      }
    });
